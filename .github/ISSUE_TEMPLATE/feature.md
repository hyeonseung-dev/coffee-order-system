...
> AI Draft를 그대로 승인하지 않고, 구현 담당자가 관련 설계 문서와 코드를 확인한 뒤 자신의 언어로 작성합니다.

### 해결하려는 문제

<!-- 이번 Issue가 실제로 해결해야 하는 문제는 무엇인가? -->

### 왜 지금 필요한가

<!-- 선행 기능, 프로젝트 단계, 사용자 가치 관점에서 왜 지금 구현하는가? -->
...
## ChatGPT Refinement 결과

> ChatGPT는 누락·충돌·위험·대안을 제시하고, 최종 요구사항·범위·설계는 Human이 결정합니다.
...
- [ ] 담당 Human이 문제·규칙·설계·트레이드오프·테스트·검증을 검토했다.
- [ ] ChatGPT 검토 후 Human이 요구사항·범위·설계를 최종 결정했다.
- [ ] 목적과 요구사항이 명확하다.
